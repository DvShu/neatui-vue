import{L as o,_ as c}from"./chunks/theme.r1xc2cnH.js";import{f as g,c as r,af as b,p as s,w as e,b as a,P as t,$ as f,o as p,j as h,u as i}from"./chunks/framework.BKc52Jce.js";const x={class:"loading-demo"},L={class:"loading-demo","nt-loading-text":"loading……","nt-loading-background":"rgba(255, 255, 255, .9)"},B={class:"loading-demo"},w=JSON.parse('{"title":"Loading 加载","description":"","frontmatter":{},"headers":[],"relativePath":"components/loading.md","filePath":"components/loading.md","lastUpdated":1720107457000}'),P={name:"components/loading.md"},I=Object.assign(P,{setup(A){const m=g(!0),u=g(!1);function E(){u.value=!0,setTimeout(()=>{u.value=!1},3e3)}const k=g(!1);function y(){k.value=!0}function C(){k.value=!1}let v;function F(){v=o.open(),setTimeout(()=>{v.close()},3e3)}return(D,n)=>{const d=f("CodePreview"),l=f("ClientOnly");return p(),r("div",null,[n[11]||(n[11]=b('<h1 id="loading-加载" tabindex="-1">Loading 加载 <a class="header-anchor" href="#loading-加载" aria-label="Permalink to &quot;Loading 加载&quot;">​</a></h1><p>数据加载时显示的动效。</p><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><h3 id="区域加载" tabindex="-1">区域加载 <a class="header-anchor" href="#区域加载" aria-label="Permalink to &quot;区域加载&quot;">​</a></h3><p>在某一个区域加载数据时展示加载动画，防止页面失去响应，提高用户体验</p>',5)),s(l,null,{default:e(()=>[s(d,null,{preview:e(()=>[h((p(),r("div",x,n[0]||(n[0]=[t(" 内容加载区域 ")]))),[[i(o),m.value]])]),default:e(()=>[n[1]||(n[1]=a("textarea",{lang:"vue-html"},`  <div class="loading-demo" v-loading="loading">
    内容加载区域
  </div>
  `,-1))]),_:1})]),_:1}),n[12]||(n[12]=a("h3",{id:"自定义内容",tabindex:"-1"},[t("自定义内容 "),a("a",{class:"header-anchor",href:"#自定义内容","aria-label":'Permalink to "自定义内容"'},"​")],-1)),n[13]||(n[13]=a("p",null,"你可以自定义加载中组件的文字，背景颜色。",-1)),n[14]||(n[14]=a("p",null,[t("在绑定了 "),a("code",null,"v-loading"),t(" 指令的元素上添加 "),a("code",null,"nt-loading-text"),t(" 属性，其值会被渲染为加载文案，并显示在加载图标的下方；将其设置为空字符串可以用于取消文本。"),a("code",null,"nt-loading-background"),t(" 用来设定背景色值。")],-1)),s(l,null,{default:e(()=>[s(d,null,{preview:e(()=>[h((p(),r("div",L,n[2]||(n[2]=[t(" 内容加载区域 ")]))),[[i(o),m.value]])]),default:e(()=>[n[3]||(n[3]=a("textarea",{lang:"vue-html"},`  <div
    class="loading-demo"
    v-loading="loading"
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">loadingInstance2.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">close</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div>`,7)),s(l,null,{default:e(()=>[s(d,null,{preview:e(()=>[s(i(c),{onClick:F},{default:e(()=>n[9]||(n[9]=[t("开始")])),_:1})]),default:e(()=>[n[10]||(n[10]=a("textarea",{lang:"vue-html"},`  <script setup>
    let loadingInstance;
