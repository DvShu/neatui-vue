import{u as q,h,i as o,j as l,_ as i}from"./chunks/theme.9mRyZSWZ.js";import{d as F,c as v,l as t,w as d,ab as f,b as a,G as r,U as p,o as y,z as e}from"./chunks/framework.MCgil6G4.js";const x=f('<h1 id="form" tabindex="-1">Form <a class="header-anchor" href="#form" aria-label="Permalink to &quot;Form&quot;">​</a></h1><p>包含数据录入、校验以及对应样式。</p><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><h3 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to &quot;基础用法&quot;">​</a></h3><p>基本的表单数据域控制展示，包含布局、初始化、验证、提交。数据验证采用 <a href="https://gitee.com/towardly/ph/wikis/utils/validator" target="_blank" rel="noreferrer">ph-utils/validator</a></p>',5),g=a("textarea",{lang:"vue"},`
  ...
  `,-1),k=a("h3",{id:"行内表单",tabindex:"-1"},[r("行内表单 "),a("a",{class:"header-anchor",href:"#行内表单","aria-label":'Permalink to "行内表单"'},"​")],-1),P=a("p",null,"当前表单较简单时，可以在一行内放置表单。",-1),V=a("p",null,[r("通过设置 "),a("code",null,"inline"),r(" 属性为 "),a("code",null,"true"),r(" 可以让表单域变为行内的表单域。")],-1),C=a("textarea",{lang:"vue-html"},`
  <nt-form inline>
    <nt-form-item label="用户名" required name="username">
