import{t as d,l as u,v as _}from"./chunks/theme.CjnrSd6H.js";import{e as g,o as m,c as b,g as e,w as a,ae as h,b as t,K as n,Y as s,l as o}from"./chunks/framework.zsgsDjJh.js";const f=h("",5),P=t("textarea",{lang:"vue"},`
  ...
  `,-1),q=t("hr",null,null,-1),C=t("hr",null,null,-1),k=t("h3",{id:"单页隐藏",tabindex:"-1"},[n("单页隐藏 "),t("a",{class:"header-anchor",href:"#单页隐藏","aria-label":'Permalink to "单页隐藏"'},"​")],-1),V=t("p",null,[n("当只有一页时，通过 "),t("code",null,"single-hide"),n(" 配置隐藏分页")],-1),w=t("textarea",{lang:"vue"},`
  <script setup lang="ts">
