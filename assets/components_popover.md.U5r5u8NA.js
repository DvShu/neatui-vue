import{w as l,_ as a}from"./chunks/theme.BPBBkDg1.js";import{e as u,o as m,c as _,g as e,w as t,ae as s,b as r,J as n,X as i,l as o}from"./chunks/framework.-x160Rg7.js";const g=s('<h1 id="popover-弹出气泡" tabindex="-1">Popover 弹出气泡 <a class="header-anchor" href="#popover-弹出气泡" aria-label="Permalink to &quot;Popover 弹出气泡&quot;">​</a></h1><p>点击/鼠标移入元素，弹出气泡式的卡片浮层。在内容周围弹出一些隐藏的信息。和 <code>Tooltip</code> 的区别是，用户可以对浮层上的元素进行操作，因此它可以承载更复杂的内容，比如链接或按钮等。</p><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><h3 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to &quot;基础用法&quot;">​</a></h3><p>最简单的用法，通过 <code>content</code> 传递浮层内容。</p>',5),v=r("textarea",{lang:"vue-html"},`
  ...
  `,-1),w=r("h3",{id:"位置",tabindex:"-1"},[n("位置 "),r("a",{class:"header-anchor",href:"#位置","aria-label":'Permalink to "位置"'},"​")],-1),x=r("p",null,[n("有 "),r("code",null,"12"),n(" 个弹出位置。通过 "),r("code",null,"placement"),n(" 属性设置弹出位置。")],-1),k=r("textarea",{lang:"vue-html"},`
