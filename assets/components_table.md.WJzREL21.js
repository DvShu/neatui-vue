import{Q as o,_ as r,l as q}from"./chunks/theme.Dvi9yxM-.js";import{e as v,c as C,g as e,w as a,ae as k,b as t,M as s,Z as y,o as T,q as h,t as A,i as n}from"./chunks/framework.CqWuvRde.js";const D=k('<h1 id="table-表格" tabindex="-1">Table 表格 <a class="header-anchor" href="#table-表格" aria-label="Permalink to &quot;Table 表格&quot;">​</a></h1><p>用于展示大量结构化数据</p><p>这个表格只是一个简单的数据展示功能，只包含有固定表头和列、排序功能。如果当前组件不能满足需求需要使用更多功能的时候，可以考虑使用 <a href="/neatui-vue/components/tanstacktable">TanstackTable</a></p><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><h3 id="基础表格" tabindex="-1">基础表格 <a class="header-anchor" href="#基础表格" aria-label="Permalink to &quot;基础表格&quot;">​</a></h3><p>通过 <code>data</code> 定义数据源, 通过 <code>columns</code> 定义列，最后一列为各种操作</p>',6),B=t("textarea",{lang:"vue"},`
  ...
  `,-1),z=t("h3",{id:"表尾合计行",tabindex:"-1"},[s("表尾合计行 "),t("a",{class:"header-anchor",href:"#表尾合计行","aria-label":'Permalink to "表尾合计行"'},"​")],-1),G=t("p",null,[s("设置 "),t("code",null,"renderSummary"),s(" 函数来渲染表尾合计行")],-1),H=t("textarea",{lang:"vue"},`
  <script setup>
  ...
  `,-1),K=t("h3",{id:"多级表头",tabindex:"-1"},[s("多级表头 "),t("a",{class:"header-anchor",href:"#多级表头","aria-label":'Permalink to "多级表头"'},"​")],-1),L=t("p",null,[s("配置 "),t("code",null,"columns"),s(" 的时候，给某一列增加一个 "),t("code",null,"children"),s(" 就能实现表头分组")],-1),W=t("textarea",{lang:"vue"},`
  <script setup>
    const columns4 = [{
      title: '姓名',
      key: 'name'
