import{n as u}from"./chunks/theme.DS74rj3R.js";import{d as x,f as i,c as P,ag as s,l as t,w as l,b as a,R as o,a1 as v,o as V,u as p}from"./chunks/framework.DcK8S9T6.js";const w=JSON.parse('{"title":"Input 输入框","description":"","frontmatter":{},"headers":[],"relativePath":"components/input.md","filePath":"components/input.md","lastUpdated":1729613669000}'),I={name:"components/input.md"},y=x({...I,setup(q){const m=i(""),c=i(""),h=i(""),b=i("");function g(f){let e=parseInt(f,10);return Number.isNaN(e)?e="":e=Math.abs(e),String(e)}return(f,e)=>{const n=v("CodePreview"),r=v("ClientOnly");return V(),P("div",null,[e[8]||(e[8]=s('<h1 id="input-输入框" tabindex="-1">Input 输入框 <a class="header-anchor" href="#input-输入框" aria-label="Permalink to &quot;Input 输入框&quot;">​</a></h1><p>通过鼠标或键盘输入内容，是最基础的表单域的包装。</p><h2 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to &quot;基础用法&quot;">​</a></h2><h3 id="基本使用" tabindex="-1">基本使用 <a class="header-anchor" href="#基本使用" aria-label="Permalink to &quot;基本使用&quot;">​</a></h3><p>文本输入的基础用法。</p>',5)),t(r,null,{default:l(()=>[t(n,null,{default:l(()=>e[4]||(e[4]=[a("textarea",{lang:"vue-html"},`<nt-input placeholder="请输入内容"></nt-input>
`,-1)])),_:1})]),_:1}),e[9]||(e[9]=a("h3",{id:"输入解析",tabindex:"-1"},[o("输入解析 "),a("a",{class:"header-anchor",href:"#输入解析","aria-label":'Permalink to "输入解析"'},"​")],-1)),e[10]||(e[10]=a("p",null,[o("通过传递 "),a("code",null,"parser"),o(" 在接受到输入值的时候进行解析，例如：只允许输入正整数")],-1)),t(r,null,{default:l(()=>[t(n,null,{preview:l(()=>[t(p(u),{modelValue:m.value,"onUpdate:modelValue":e[0]||(e[0]=d=>m.value=d),placeholder:"请输入正整数",parser:g},null,8,["modelValue"])]),default:l(()=>[e[5]||(e[5]=a("textarea",{lang:"vue"},`  <script setup lang="ts">
  ...
  `,-1))]),_:1})]),_:1}),e[12]||(e[12]=a("h3",{id:"禁用状态",tabindex:"-1"},[o("禁用状态 "),a("a",{class:"header-anchor",href:"#禁用状态","aria-label":'Permalink to "禁用状态"'},"​")],-1)),e[13]||(e[13]=a("p",null,[o("通过 "),a("code",null,"disabled"),o(" 属性设置输入框为禁用状态。")],-1)),t(r,null,{default:l(()=>[t(n,null,{default:l(()=>e[7]||(e[7]=[a("textarea",{lang:"vue-html"},`  <nt-input placeholder="请输入内容" disabled></nt-input>
