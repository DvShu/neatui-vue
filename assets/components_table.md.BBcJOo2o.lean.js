import{A as s,_ as i,j as A}from"./chunks/theme.BXlgI-md.js";import{e as N,c as D,l as t,w as d,ab as _,b as e,z as a,S as g,o as B,A as u,t as I,j as n}from"./chunks/framework.RALdISJs.js";const O=_("",5),E=e("textarea",{lang:"vue"},`
  <script setup>
    import { h } from 'vue';
    const dataSource = [
      {
  ...
  `,-1),$=e("h3",{id:"边框",tabindex:"-1"},[a("边框 "),e("a",{class:"header-anchor",href:"#边框","aria-label":'Permalink to "边框"'},"​")],-1),J=e("p",null,[a("默认情况下，"),e("code",null,"Table"),a(" 组件是不具有竖直方向的边框的， 如果需要，可以使用 "),e("code",null,"border"),a(" 属性，把该属性设置为 "),e("code",null,"true"),a(" 即可启用。")],-1),z=e("textarea",{lang:"vue"},`
  <template>
