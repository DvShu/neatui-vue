import{N as r,_ as h,l as A}from"./chunks/theme.1ktC8hXP.js";import{e as D,c as B,g as e,w as a,ae as u,b as t,M as n,Z as b,o as P,q as c,t as V,i as s}from"./chunks/framework.CqWuvRde.js";const N=u('<h1 id="table-表格" tabindex="-1">Table 表格 <a class="header-anchor" href="#table-表格" aria-label="Permalink to &quot;Table 表格&quot;">​</a></h1><p>用于展示大量结构化数据</p><p>这个表格只是一个简单的数据展示功能，只包含有固定表头和列、排序功能。如果当前组件不能满足需求需要使用更多功能的时候，可以考虑使用 <a href="/neatui-vue/components/tanstacktable">TanstackTable</a></p><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><h3 id="基础表格" tabindex="-1">基础表格 <a class="header-anchor" href="#基础表格" aria-label="Permalink to &quot;基础表格&quot;">​</a></h3><p>通过 <code>data</code> 定义数据源, 通过 <code>columns</code> 定义列，最后一列为各种操作</p>',6),I=t("textarea",{lang:"vue"},`
  ...
  `,-1),$=t("h3",{id:"边框",tabindex:"-1"},[n("边框 "),t("a",{class:"header-anchor",href:"#边框","aria-label":'Permalink to "边框"'},"​")],-1),J=t("p",null,[n("默认情况下，"),t("code",null,"Table"),n(" 组件是不具有竖直方向的边框的， 如果需要，可以使用 "),t("code",null,"border"),n(" 属性，把该属性设置为 "),t("code",null,"true"),n(" 即可启用。")],-1),j=t("textarea",{lang:"vue"},`
  <template>
    <nt-table :data="dataSource" :columns="columns" border></nt-table>
  </template>
  `,-1),K=t("h3",{id:"空表格",tabindex:"-1"},[n("空表格 "),t("a",{class:"header-anchor",href:"#空表格","aria-label":'Permalink to "空表格"'},"​")],-1),M=t("p",null,"数据列表没有数据时，显示空表格",-1),Z=t("textarea",{lang:"vue"},`
  <template>
