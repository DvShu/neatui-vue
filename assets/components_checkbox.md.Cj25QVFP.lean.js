import{b as x,c as b}from"./chunks/theme.D2m7nk3t.js";import{d as V,e as v,c as k,l as a,w as d,ab as g,b as e,G as t,U as C,o as p,z as n,F as f,V as _}from"./chunks/framework.MCgil6G4.js";const q=g('<h1 id="checkbox-复选框" tabindex="-1">Checkbox 复选框 <a class="header-anchor" href="#checkbox-复选框" aria-label="Permalink to &quot;Checkbox 复选框&quot;">​</a></h1><p>在一组备选项中进行多选。适用提醒用户勾选场景，突出多选框选项，可以有效增加用户识别度。</p><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><h3 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to &quot;基础用法&quot;">​</a></h3><p>单独使用可以表示两种状态之间的切换；在 <code>nt-checkbox</code> 元素中定义 <code>v-model</code> 绑定变量，单一的 <code>checkbox</code> 中，默认绑定变量的值会是 <code>Boolean</code>，选中为 <code>true</code>。</p>',5),Z=e("textarea",{lang:"vue-html"},`
  ...
  `,-1),G=e("h3",{id:"选项框组",tabindex:"-1"},[t("选项框组 "),e("a",{class:"header-anchor",href:"#选项框组","aria-label":'Permalink to "选项框组"'},"​")],-1),B=e("p",null,[t("使用 "),e("code",null,"nt-checkbox-group"),t(" 元素来包裹 "),e("code",null,"nt-checkbox"),t(" 元素，实现复选框组。使用时需要给 "),e("code",null,"nt-checkbox"),t(" 传递 "),e("code",null,"value"),t(" 属性。")],-1),w=e("textarea",{lang:"vue"},`
  <script setup>
    import { ref } from 'vue';
  ...
  `,-1),I=e("h3",{id:"中间状态",tabindex:"-1"},[t("中间状态 "),e("a",{class:"header-anchor",href:"#中间状态","aria-label":'Permalink to "中间状态"'},"​")],-1),U=e("p",null,[t("设置 "),e("code",null,"indeterminate"),t(" 属性，表示不确定状态，一般用于实现全选的效果，实现部分选中的状态。")],-1),E=e("textarea",{lang:"vue"},`
  <script setup>
    import { ref } from 'vue';
  ...
  `,-1),J=e("h3",{id:"按钮样式",tabindex:"-1"},[t("按钮样式 "),e("a",{class:"header-anchor",href:"#按钮样式","aria-label":'Permalink to "按钮样式"'},"​")],-1),N=e("p",null,[t("只需要设置 "),e("code",null,"checkbox"),t(" 的 "),e("code",null,"type"),t(" 为 "),e("code",null,"button"),t("；就能将复选框变为按钮样式")],-1),O=e("textarea",{lang:"vue"},`
  <script setup>
    import { ref } from 'vue';
    const cities= [['CD', '成都'], ['BJ', '北京'], ['SZ', '深圳'], ['HZ', '杭州']];
    const checkedCities = ref(['CD', 'SZ']);
