const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/theme.B1Hg1tt-.js","assets/chunks/framework.hs56f8h4.js"])))=>i.map(i=>d[i]);
import{f as k,x as E,D as y,O as c,c as f,af as h,l as e,w as a,b as t,Q as o,a0 as u,o as v,u as n}from"./chunks/framework.hs56f8h4.js";import{W as _,X as F,Y as C,Z as T,n as A,o as d,$ as w,I as x,H as B,a0 as q,a1 as D}from"./chunks/theme.B1Hg1tt-.js";const O=JSON.parse('{"title":"Theme 主题切换","description":"","frontmatter":{},"headers":[],"relativePath":"components/theme.md","filePath":"components/theme.md","lastUpdated":1729613669000}'),$={name:"components/theme.md"},I=Object.assign($,{setup(P){const l=k(""),m=k("");E(l,i=>{c(()=>import("./chunks/theme.B1Hg1tt-.js").then(s=>s.ay),__vite__mapDeps([0,1])).then(s=>s.applyTheme(i))}),y(()=>{c(()=>import("./chunks/theme.B1Hg1tt-.js").then(i=>i.ay),__vite__mapDeps([0,1])).then(i=>{l.value=i.getTheme()})});function b(){const i=document.getElementById("color-theme-style");if(i!=null){let s=i.innerHTML;s=s.replace("{",` {\r
  `).replaceAll(";",`;\r
  `).replace("  }","}"),m.value=s}}return(i,s)=>{const r=u("CodePreview"),p=u("ClientOnly");return v(),f("div",null,[s[5]||(s[5]=h(`<h1 id="theme-主题切换" tabindex="-1">Theme 主题切换 <a class="header-anchor" href="#theme-主题切换" aria-label="Permalink to &quot;Theme 主题切换&quot;">​</a></h1><p>通过切换主题来减轻长时间使用屏幕带来的视觉疲劳</p><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><blockquote><ol><li>主题切换是通过 <a href="https://www.npmjs.com/package/ph-utils" target="_blank" rel="noreferrer">ph-utils</a> 工具库的 <code>theme</code> 工具类控制</li><li>为了每次切换主题后，重新加载能够生效，需要在应用开始的时候, 执行 <code>initTheme()</code> 方法</li></ol></blockquote><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-HYkmA" id="tab-A1qQfyk" checked><label for="tab-A1qQfyk">main.ts</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { initTheme } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;ph-utils/theme&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">initTheme</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">().</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">then</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><h3 id="自定义风格" tabindex="-1">自定义风格 <a class="header-anchor" href="#自定义风格" aria-label="Permalink to &quot;自定义风格&quot;">​</a></h3><p>框架内置的主题切换其实就是一个排版的样式，核心的主题切换的逻辑是调用的 <code>ph-utils</code> 库的 <code>theme</code> 模块相关函数来实现的。</p><p>通常调用的模块有: <code>getTheme()</code>、<code>applyTheme()</code></p><p>所以完全可以自定义按钮来实现主题切换, 下面就使用 <code>RadioGroup + Icon</code> 来实现。</p>`,6)),e(p,null,{default:a(()=>[e(r,null,{preview:a(()=>[e(n(A),{modelValue:l.value,"onUpdate:modelValue":s[0]||(s[0]=g=>l.value=g)},{default:a(()=>[e(n(d),{value:"auto",type:"button"},{default:a(()=>[e(n(w))]),_:1}),e(n(d),{value:"light",type:"button"},{default:a(()=>[e(n(x))]),_:1}),e(n(d),{value:"dark",type:"button"},{default:a(()=>[e(n(B))]),_:1})]),_:1},8,["modelValue"])]),default:a(()=>[s[2]||(s[2]=t("textarea",{lang:"vue"},`  <script setup lang="ts">
  ...
  `,-1))]),_:1})]),_:1}),s[7]||(s[7]=t("h3",{id:"更改主题色",tabindex:"-1"},[o("更改主题色 "),t("a",{class:"header-anchor",href:"#更改主题色","aria-label":'Permalink to "更改主题色"'},"​")],-1)),s[8]||(s[8]=t("p",null,[o("除了修改主题风格，还可以修改主题色，通过修改 "),t("code",null,"ThemeColor"),o(" 来实现。")],-1)),e(p,null,{default:a(()=>[e(r,null,{preview:a(()=>[e(n(q),{onChange:b})]),default:a(()=>[s[3]||(s[3]=t("textarea",{lang:"vue-html"},`  <nt-theme-color></nt-theme-color>
  `,-1))]),_:1})]),_:1}),s[9]||(s[9]=t("p",null,"生成的主题色代码如下:",-1)),e(p,null,{default:a(()=>[e(D,{"source-code":m.value},{default:a(()=>s[4]||(s[4]=[t("textarea",{lang:"css"},`:root {
