...
`,-1),D=t("h3",{id:"图标按钮",tabindex:"-1"},[e("图标按钮 "),t("a",{class:"header-anchor",href:"#图标按钮","aria-label":'Permalink to "图标按钮"'},"​")],-1),A=t("p",null,"直接在 Button 内使用 Icon 组件。",-1),N=t("textarea",{lang:"vue-html"},`
...
`,-1),V=t("h3",{id:"透明背景",tabindex:"-1"},[e("透明背景 "),t("a",{class:"header-anchor",href:"#透明背景","aria-label":'Permalink to "透明背景"'},"​")],-1),I=t("p",null,[t("code",null,"ghost"),e(" 背景变为透明，常用在有色背景上")],-1),w=t("textarea",{lang:"vue-html"},`
  ...
  `,-1),j=t("h3",{id:"扩展-type",tabindex:"-1"},[e("扩展 "),t("code",null,"type"),e(),t("a",{class:"header-anchor",href:"#扩展-type","aria-label":'Permalink to "扩展 `type`"'},"​")],-1),R=t("p",null,[e("通过给 "),t("code",null,"type"),e(" 设置一个非预设的值，然后定义 "),t("code",null,".nt-btn-x"),e(" 的样式。")],-1),$=t("textarea",{lang:"vue"},`
  <template>
