import{N as c,O as u,m as d,n as h,_ as w,l as q}from"./chunks/theme.DASJ6p6U.js";import{f,c as v,ag as E,l as a,w as s,b as n,R as i,a1 as V,o as p,u as t,k as m,a as _}from"./chunks/framework.DdiFAQ9y.js";const x={class:"nt-tabs"},C={class:"nt-tabs-content"},F={key:0},D={key:1},T={class:"login-form-wrapper"},$={class:"nt-tabs"},B={class:"nt-tabs-content"},U={class:"nt-tabs"},z={class:"nt-tabs-content"},Z={key:0},N={key:1},G=JSON.parse('{"title":"Tabs 标签页","description":"","frontmatter":{},"headers":[],"relativePath":"components/tabs.md","filePath":"components/tabs.md","lastUpdated":1732112404000}'),R={name:"components/tabs.md"},H=Object.assign(R,{setup(j){const r=f("1"),k=f("login"),b=f({username:"",password:""}),o=f({username:"",password:"",password2:""}),P=[{key:"username",rules:["required"],message:"用户名不能为空"},{key:"password",rules:[/^(?=.*[0-9])(?=.*[a-zA-Z])([a-zA-Z0-9]{6,15})$/],message:"密码为6~15位字母+数字"}],A=[{key:"username",rules:["required"],message:"用户名不能为空"},{key:"password",rules:[/^(?=.*[0-9])(?=.*[a-zA-Z])([a-zA-Z0-9]{6,15})$/],message:"密码为6~15位字母+数字"},{key:"password2",rules:["required","same:password"],message:"两次密码输入不一致"}];return(O,e)=>{const g=V("CodePreview"),y=V("ClientOnly");return p(),v("div",null,[e[19]||(e[19]=E('<h1 id="tabs-标签页" tabindex="-1">Tabs 标签页 <a class="header-anchor" href="#tabs-标签页" aria-label="Permalink to &quot;Tabs 标签页&quot;">​</a></h1><p>选项卡切换组件；其实这个模块的内容就是 <a href="/litos-ui-vue/components/tabbar">Tabbar 标签栏</a> + 内容区域；所以就没有单独抽取为组件，转而提供 <code>css</code> 样式表，通过手动引入样式就能达到效果。</p><h2 id="引入" tabindex="-1">引入 <a class="header-anchor" href="#引入" aria-label="Permalink to &quot;引入&quot;">​</a></h2><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;litos-ui-vue/style/util/tabs.css&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br></div></div><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><h3 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to &quot;基础用法&quot;">​</a></h3><p>基础的、简洁的标签页。</p>',7)),a(y,null,{default:s(()=>[a(g,null,{preview:s(()=>[n("div",x,[a(t(c),{modelValue:r.value,"onUpdate:modelValue":e[0]||(e[0]=l=>r.value=l),type:"bar"},{default:s(()=>[a(t(u),{name:"1"},{default:s(()=>e[8]||(e[8]=[i("标签一")])),_:1}),a(t(u),{name:"2"},{default:s(()=>e[9]||(e[9]=[i("标签二")])),_:1})]),_:1},8,["modelValue"]),n("div",C,[r.value==="1"?(p(),v("div",F,"标签一")):m("",!0),r.value==="2"?(p(),v("div",D,"标签二")):m("",!0)])])]),default:s(()=>[e[10]||(e[10]=n("textarea",{lang:"vue"},`  <script setup>
    import { ref } from 'vue';
    const active = ref('1');
  <\/script>
  <template>
