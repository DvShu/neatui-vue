import{_ as n,M as c}from"./chunks/theme.Bw2aQQ0V.js";import{c as p,k as o,w as d,b as e,y as t,ab as g,S as u,o as b,z as s}from"./chunks/framework.DQF4kMpX.js";const M=e("h1",{id:"message-消息提示",tabindex:"-1"},[t("Message 消息提示 "),e("a",{class:"header-anchor",href:"#message-消息提示","aria-label":'Permalink to "Message 消息提示"'},"​")],-1),x=e("p",null,"常用于主动操作后的反馈提示。更多用于系统级通知的被动提醒。",-1),C=e("h2",{id:"基础用法",tabindex:"-1"},[t("基础用法 "),e("a",{class:"header-anchor",href:"#基础用法","aria-label":'Permalink to "基础用法"'},"​")],-1),k=e("p",null,[t("从顶部出现，"),e("code",null,"3"),t(" 秒后自动消失; 可以接收一个字符串被显示为正文内容")],-1),P=e("textarea",{lang:"ts"},`
