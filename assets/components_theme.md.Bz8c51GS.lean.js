const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/theme.DsPTYL3Z.js","assets/chunks/framework.hs56f8h4.js"])))=>i.map(i=>d[i]);
import{f as k,x as E,D as y,O as c,c as f,af as h,l as e,w as a,b as t,Q as o,a0 as u,o as v,u as n}from"./chunks/framework.hs56f8h4.js";import{W as _,X as F,Y as C,Z as T,n as w,o as d,$ as x,I as A,H as B,a0 as D,a1 as q}from"./chunks/theme.DsPTYL3Z.js";const V=JSON.parse('{"title":"Theme 主题切换","description":"","frontmatter":{},"headers":[],"relativePath":"components/theme.md","filePath":"components/theme.md","lastUpdated":1729613669000}'),$={name:"components/theme.md"},I=Object.assign($,{setup(P){const l=k(""),m=k("");E(l,i=>{c(()=>import("./chunks/theme.DsPTYL3Z.js").then(s=>s.ay),__vite__mapDeps([0,1])).then(s=>s.applyTheme(i))}),y(()=>{c(()=>import("./chunks/theme.DsPTYL3Z.js").then(i=>i.ay),__vite__mapDeps([0,1])).then(i=>{l.value=i.getTheme()})});function b(){const i=document.getElementById("color-theme-style");if(i!=null){let s=i.innerHTML;s=s.replace("{",` {\r
  `).replaceAll(";",`;\r
  `).replace("  }","}"),m.value=s}}return(i,s)=>{const r=u("CodePreview"),p=u("ClientOnly");return v(),f("div",null,[s[5]||(s[5]=h(`<h1 id="theme-主题切换" tabindex="-1">Theme 主题切换 <a class="header-anchor" href="#theme-主题切换" aria-label="Permalink to &quot;Theme 主题切换&quot;">​</a></h1><p>通过切换主题来减轻长时间使用屏幕带来的视觉疲劳</p><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><blockquote><ol><li>主题切换是通过 <a href="https://www.npmjs.com/package/ph-utils" target="_blank" rel="noreferrer">ph-utils</a> 工具库的 <code>theme</code> 工具类控制</li><li>为了每次切换主题后，重新加载能够生效，需要在应用开始的时候, 执行 <code>initTheme()</code> 方法</li></ol></blockquote><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-Wzb4i" id="tab-1l39tgO" checked><label for="tab-1l39tgO">main.ts</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { initTheme } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;ph-utils/theme&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
