import{_ as s,i as m,j as C,L as y,M as p,D as x}from"./chunks/theme.CVO0TTn9.js";import{d as q,f as c,c as N,af as v,l as d,w as e,b as o,Q as l,a0 as k,o as V,u as a}from"./chunks/framework.hs56f8h4.js";const $=JSON.parse('{"title":"Dialog","description":"","frontmatter":{},"headers":[],"relativePath":"components/dialog.md","filePath":"components/dialog.md","lastUpdated":1726671680000}'),T={name:"components/dialog.md"},I=q({...T,setup(A){const g=c(!1),f=c(!1),b=c(!1),h=c(!1);function w(n,t){if(n==="ok"){const r=y.open({to:".edit-dialog",bar:!0});setTimeout(()=>{r.close(),p.success("提交成功"),t()},2e3)}else t()}function D(){x.alert("这是 Alert Content","Alert Title").then(n=>{n===!0?p.success("点击了确定"):p.info("点击了关闭")})}function P(){x.confirm("这是 Confirm Content","Confirm Title",{type:"success"}).then(n=>{n===!0?p.success("点击了确定"):p.info("点击了关闭")})}function B(){x.prompt("请输入用户名","Prompt Title").then(n=>{p.info("用户名："+n)})}return(n,t)=>{const r=k("CodePreview"),u=k("ClientOnly");return V(),N("div",null,[t[25]||(t[25]=v('<h1 id="dialog" tabindex="-1">Dialog <a class="header-anchor" href="#dialog" aria-label="Permalink to &quot;Dialog&quot;">​</a></h1><p>在保留当前页面状态的情况下，弹出一个对话框告知用户并承载相关操作，包含：标题区、内容区、操作区</p><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><h3 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to &quot;基础用法&quot;">​</a></h3><p>需要设置 <code>model-value / v-model</code> 属性，它接收 <code>Boolean</code>，当为 <code>true</code> 时显示 <code>Dialog</code>。<code>title</code> 属性用于定义标题，它是可选的，默认值为空。</p>',5)),d(u,null,{default:e(()=>[d(r,null,{preview:e(()=>[d(a(s),{type:"primary",onClick:t[0]||(t[0]=i=>g.value=!0)},{default:e(()=>t[8]||(t[8]=[l("显示 Dialog")])),_:1}),d(a(m),{modelValue:g.value,"onUpdate:modelValue":t[1]||(t[1]=i=>g.value=i),title:"Title"},{default:e(()=>t[9]||(t[9]=[l(" 这是内容 ")])),_:1},8,["modelValue"])]),default:e(()=>[t[10]||(t[10]=o("textarea",{lang:"vue"},`  <script setup lang="ts">
    import { ref } from 'vue';
    //-
