import{L as o,_ as c}from"./chunks/theme.D80Jzo0T.js";import{f as k,c as r,ag as b,l as s,w as e,b as a,R as t,a1 as E,o as p,h,u as i}from"./chunks/framework.DcK8S9T6.js";const x={class:"loading-demo"},L={class:"loading-demo","nt-loading-text":"loading……","nt-loading-background":"rgba(255, 255, 255, .9)"},B={class:"loading-demo"},w=JSON.parse('{"title":"Loading 加载","description":"","frontmatter":{},"headers":[],"relativePath":"components/loading.md","filePath":"components/loading.md","lastUpdated":1720107457000}'),A={name:"components/loading.md"},I=Object.assign(A,{setup(D){const m=k(!0),u=k(!1);function f(){u.value=!0,setTimeout(()=>{u.value=!1},3e3)}const g=k(!1);function y(){g.value=!0}function C(){g.value=!1}let v;function F(){v=o.open(),setTimeout(()=>{v.close()},3e3)}return(P,n)=>{const d=E("CodePreview"),l=E("ClientOnly");return p(),r("div",null,[n[11]||(n[11]=b('<h1 id="loading-加载" tabindex="-1">Loading 加载 <a class="header-anchor" href="#loading-加载" aria-label="Permalink to &quot;Loading 加载&quot;">​</a></h1><p>数据加载时显示的动效。</p><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><h3 id="区域加载" tabindex="-1">区域加载 <a class="header-anchor" href="#区域加载" aria-label="Permalink to &quot;区域加载&quot;">​</a></h3><p>在某一个区域加载数据时展示加载动画，防止页面失去响应，提高用户体验</p>',5)),s(l,null,{default:e(()=>[s(d,null,{preview:e(()=>[h((p(),r("div",x,n[0]||(n[0]=[t(" 内容加载区域 ")]))),[[i(o),m.value]])]),default:e(()=>[n[1]||(n[1]=a("textarea",{lang:"vue-html"},`  <div class="loading-demo" v-loading="loading">
    内容加载区域
  </div>
