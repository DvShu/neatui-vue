import{L as l,_ as r}from"./chunks/theme.W1bS7NXL.js";import{e as g,c as o,j as t,w as n,af as k,b as a,N as e,$ as m,o as c,g as h,s}from"./chunks/framework.Dl8nlkpL.js";const C=k('<h1 id="loading-加载" tabindex="-1">Loading 加载 <a class="header-anchor" href="#loading-加载" aria-label="Permalink to &quot;Loading 加载&quot;">​</a></h1><p>数据加载时显示的动效。</p><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><h3 id="区域加载" tabindex="-1">区域加载 <a class="header-anchor" href="#区域加载" aria-label="Permalink to &quot;区域加载&quot;">​</a></h3><p>在某一个区域加载数据时展示加载动画，防止页面失去响应，提高用户体验</p>',5),F=a("textarea",{lang:"vue-html"},`
  ...
  `,-1),O=a("h3",{id:"进度条风格",tabindex:"-1"},[e("进度条风格 "),a("a",{class:"header-anchor",href:"#进度条风格","aria-label":'Permalink to "进度条风格"'},"​")],-1),N=a("p",null,[e("通过传递 "),a("code",null,"bar"),e(" 参数可以将圆形加载变为进度条风格。")],-1),w=a("textarea",{lang:"vue"},`
  <script setup>
