import{H as c}from"./chunks/theme.D80Jzo0T.js";import{f as b,c as w,ag as v,l as t,w as o,b as l,R as s,a1 as V,o as P,u as a}from"./chunks/framework.DcK8S9T6.js";const U=JSON.parse('{"title":"Select 选择器","description":"","frontmatter":{},"headers":[],"relativePath":"components/select.md","filePath":"components/select.md","lastUpdated":1731765417000}'),q={name:"components/select.md"},N=Object.assign(q,{setup(S){const f=["苹果","香蕉","橙子","葡萄","柠檬","草莓","樱桃","芒果","猕猴桃","杨梅","菠萝","西瓜","哈密瓜","桃子","梨","柿子","榴莲","椰子","龙眼","荔枝"],r=f.slice(0,10).map((p,e)=>({value:e,label:p})),h=b(r),i=b(""),x=b([]),u=b([]),g=b(!1);function y(p){g.value=!0,setTimeout(()=>{p?h.value=f.filter(e=>e.includes(p)).map((e,n)=>({value:n,label:e})):h.value=f.slice(0,10).map((e,n)=>({value:n,label:e})),g.value=!1},1500)}return(p,e)=>{const n=V("CodePreview"),m=V("ClientOnly");return P(),w("div",null,[e[13]||(e[13]=v('<h1 id="select-选择器" tabindex="-1">Select 选择器 <a class="header-anchor" href="#select-选择器" aria-label="Permalink to &quot;Select 选择器&quot;">​</a></h1><p>下拉选择器</p><ul><li>弹出一个下拉菜单给用户选择操作，用于代替原生的选择器，或者需要一个更优雅的多选器</li><li>当选项过多时，使用下拉菜单展示并选择内容</li></ul><blockquote><p><code>nt-select</code> 的默认宽度更改为 <code>100%</code> 当使用内联形式时，宽度将显示异常。为了保持显示正常, 您需要手动配置 <code>nt-select</code> 的宽度</p></blockquote><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><h3 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h3><p>基础用法</p>',7)),t(m,null,{default:o(()=>[t(n,null,{preview:o(()=>[t(a(c),{options:a(r),modelValue:i.value,"onUpdate:modelValue":e[0]||(e[0]=d=>i.value=d),style:{width:"180px"}},null,8,["options","modelValue"])]),default:o(()=>[e[8]||(e[8]=l("textarea",{lang:"vue"},`  <script setup lang="ts">
  ...
  `,-1))]),_:1})]),_:1}),e[14]||(e[14]=l("h3",{id:"多选",tabindex:"-1"},[s("多选 "),l("a",{class:"header-anchor",href:"#多选","aria-label":'Permalink to "多选"'},"​")],-1)),e[15]||(e[15]=l("p",null,[s("设置 "),l("code",null,"multiple"),s(" 属性即可启用多选， 此时 "),l("code",null,"v-model"),s(" 的值为当前选中值所组成的数组。默认情况下选中值会以 "),l("a",{href:"/neatui-vue/components/tag",target:"_blank"},"Tag"),s(" 组件的形式展现， 你也可以设置 "),l("code",null,"collapse-tags"),s(" 属性将它们合并为一段文字。")],-1)),t(m,null,{default:o(()=>[t(n,null,{preview:o(()=>[t(a(c),{options:a(r),modelValue:x.value,"onUpdate:modelValue":e[1]||(e[1]=d=>x.value=d),multiple:"",style:{width:"180px"}},null,8,["options","modelValue"]),t(a(c),{options:a(r),modelValue:u.value,"onUpdate:modelValue":e[2]||(e[2]=d=>u.value=d),multiple:"",style:{width:"180px"},class:"ml-10","collapse-tags":""},null,8,["options","modelValue"])]),default:o(()=>[e[9]||(e[9]=l("textarea",{lang:"vue"},`  <template>
