import{a as n,_ as r}from"./chunks/theme.BPBBkDg1.js";import{o as i,c as _,g as a,w as t,b as e,J as d,ae as h,X as c,l as o}from"./chunks/framework.-x160Rg7.js";const u=e("h1",{id:"card-卡片",tabindex:"-1"},[d("Card 卡片 "),e("a",{class:"header-anchor",href:"#card-卡片","aria-label":'Permalink to "Card 卡片"'},"​")],-1),p=e("p",null,"通用卡片应用，常用于后台概览页面。",-1),f=e("h2",{id:"典型卡片",tabindex:"-1"},[d("典型卡片 "),e("a",{class:"header-anchor",href:"#典型卡片","aria-label":'Permalink to "典型卡片"'},"​")],-1),m=e("p",null,"包含标题、内容、操作区域。",-1),x=e("textarea",{lang:"vue-html"},`
...
`,-1),v=e("div",null,"卡片内容",-1),b=e("h2",{id:"简洁卡片",tabindex:"-1"},[d("简洁卡片 "),e("a",{class:"header-anchor",href:"#简洁卡片","aria-label":'Permalink to "简洁卡片"'},"​")],-1),g=e("p",null,"只包含内容区域",-1),y=e("textarea",{lang:"vue-html"},`
...
`,-1),T=e("div",null,"卡片内容",-1),S=h('<h2 id="卡片标题" tabindex="-1">卡片标题 <a class="header-anchor" href="#卡片标题" aria-label="Permalink to &quot;卡片标题&quot;">​</a></h2><p>标题和底部区域除了可以通过 <code>header-text</code> 和 <code>footer-text</code> 传递以外，也可以通过 <code>header</code> 和 <code>footer</code> <code>slot</code> 自定义 。</p>',2),q=e("textarea",{lang:"vue-html"},`
