import{p as r,q as h,_ as p}from"./chunks/theme.DXrNpYRL.js";import{e as b,c as v,k as t,w as a,ab as m,b as e,y as d,S as _,o as f,z as l}from"./chunks/framework.DQF4kMpX.js";const x=m('<h1 id="radio-单选框" tabindex="-1">Radio 单选框 <a class="header-anchor" href="#radio-单选框" aria-label="Permalink to &quot;Radio 单选框&quot;">​</a></h1><p>在一组备选项中进行单选</p><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><h3 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to &quot;基础用法&quot;">​</a></h3><p>当只有一个选项时，可以直接通过 <code>v-model</code> 绑定一个 <code>boolean</code> 值来控制是否选中；使用 <code>slot-label</code> 来重写选项的文字。</p>',5),k=e("textarea",{lang:"vue"},`
  ...
  `,-1),S=e("h3",{id:"单选框组",tabindex:"-1"},[d("单选框组 "),e("a",{class:"header-anchor",href:"#单选框组","aria-label":'Permalink to "单选框组"'},"​")],-1),V=e("p",null,[d("结合 "),e("code",null,"nt-radio-group"),d(" 组件实现单选框组")],-1),w=e("textarea",{lang:"vue-html"},`
  <script setup>
    import { ref } from 'vue';
    const sex = ref('0');
  <\/script>
