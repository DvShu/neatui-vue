import{C as s,b as x}from"./chunks/theme.W1bS7NXL.js";import{d as q,e as p,c as k,j as o,w as a,af as y,b as e,N as d,$ as g,o as m,s as c,F as f,A as C}from"./chunks/framework.Dl8nlkpL.js";const Z=y('<h1 id="checkbox-复选框" tabindex="-1">Checkbox 复选框 <a class="header-anchor" href="#checkbox-复选框" aria-label="Permalink to &quot;Checkbox 复选框&quot;">​</a></h1><p>在一组备选项中进行多选。适用提醒用户勾选场景，突出多选框选项，可以有效增加用户识别度。</p><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><h3 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to &quot;基础用法&quot;">​</a></h3><p>单独使用可以表示两种状态之间的切换；在 <code>nt-checkbox</code> 元素中定义 <code>v-model</code> 绑定变量，单一的 <code>checkbox</code> 中，默认绑定变量的值会是 <code>Boolean</code>，选中为 <code>true</code>。</p>',5),A=e("textarea",{lang:"vue-html"},`
  <nt-checkbox label="Option1" v-model="isCheckOption"></nt-checkbox>
  `,-1),S=e("h3",{id:"禁用状态",tabindex:"-1"},[d("禁用状态 "),e("a",{class:"header-anchor",href:"#禁用状态","aria-label":'Permalink to "禁用状态"'},"​")],-1),D=e("p",null,[d("多选框不可用状态, 设置 "),e("code",null,"disabled"),d(" 属性即可。")],-1),w=e("textarea",{lang:"vue-html"},`
  ...
  `,-1),I=e("h3",{id:"中间状态",tabindex:"-1"},[d("中间状态 "),e("a",{class:"header-anchor",href:"#中间状态","aria-label":'Permalink to "中间状态"'},"​")],-1),N=e("p",null,[d("设置 "),e("code",null,"indeterminate"),d(" 属性，表示不确定状态，一般用于实现全选的效果，实现部分选中的状态。")],-1),U=e("textarea",{lang:"vue"},`
  <script setup>
    import { ref } from 'vue';
  ...
  `,-1),E=e("h3",{id:"按钮样式",tabindex:"-1"},[d("按钮样式 "),e("a",{class:"header-anchor",href:"#按钮样式","aria-label":'Permalink to "按钮样式"'},"​")],-1),J=e("p",null,[d("只需要设置 "),e("code",null,"checkbox"),d(" 的 "),e("code",null,"type"),d(" 为 "),e("code",null,"button"),d("；就能将复选框变为按钮样式")],-1),H=e("textarea",{lang:"vue"},`
  <script setup>
    import { ref } from 'vue';
    const cities= [['CD', '成都'], ['BJ', '北京'], ['SZ', '深圳'], ['HZ', '杭州']];
    const checkedCities = ref(['CD', 'SZ']);
