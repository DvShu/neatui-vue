import{_ as r,i as u,j as B,L as C,M as c,D as _}from"./chunks/theme.CjnrSd6H.js";import{d as y,e as m,o as q,c as N,g as l,w as e,ae as x,b as o,K as t,Y as v,l as d}from"./chunks/framework.zsgsDjJh.js";const V=x('<h1 id="dialog" tabindex="-1">Dialog <a class="header-anchor" href="#dialog" aria-label="Permalink to &quot;Dialog&quot;">​</a></h1><p>在保留当前页面状态的情况下，弹出一个对话框告知用户并承载相关操作，包含：标题区、内容区、操作区</p><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><h3 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to &quot;基础用法&quot;">​</a></h3><p>需要设置 <code>model-value / v-model</code> 属性，它接收 <code>Boolean</code>，当为 <code>true</code> 时显示 <code>Dialog</code>。<code>title</code> 属性用于定义标题，它是可选的，默认值为空。</p>',5),T=o("textarea",{lang:"vue"},`
  ...
  `,-1),K=x('<h3 id="消息弹窗" tabindex="-1">消息弹窗 <a class="header-anchor" href="#消息弹窗" aria-label="Permalink to &quot;消息弹窗&quot;">​</a></h3><p>模拟系统的消息提示框而实现的一套模态对话框组件，用于消息提示、确认消息和提交内容。系统自带有3种消息弹窗：<code>alert</code>、<code>confirm</code>、<code>prompt</code> 但是其样式比较简陋不太美观，消息弹窗优化了样式。</p><p>分别通过 <code>NtDialogBox.alert()</code>、<code>NtDialogBox.confirm()</code>、<code>NtDialogBox.prompt()</code> 调用</p>',3),Y=o("textarea",{lang:"vue"},`
  <script setup lang="ts">
    function openAlert() {
