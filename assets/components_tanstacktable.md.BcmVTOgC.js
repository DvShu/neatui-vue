import{S as n,T as b,_ as h}from"./chunks/theme.W1bS7NXL.js";import{d as w,c as P,j as a,w as s,af as m,b as e,N as d,$ as y,o as q,s as i,l}from"./chunks/framework.Dl8nlkpL.js";const C=m('<h1 id="tanstacktable" tabindex="-1">TanstackTable <a class="header-anchor" href="#tanstacktable" aria-label="Permalink to &quot;TanstackTable&quot;">​</a></h1><p><a href="/neatui-vue/components/table">table 表格</a>只能用于处理简单的列表展示。如果牵涉到复杂的功能比如：展开、选择等等，优先使用 <code>TanstackTable</code>。<code>TanstackTable</code> 是使用 <a href="https://tanstack.com/table/latest" target="_blank" rel="noreferrer">TanStack-Table</a> 实现。</p><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-label="Permalink to &quot;安装&quot;">​</a></h2><p>使用之前需要先安装 <code>TanStack-Table</code></p><div class="language-bash vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">npm</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> install</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> @tanstack/vue-table</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br></div></div><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><h3 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to &quot;基础用法&quot;">​</a></h3><p>展示一个简单的表格</p>',8),K=e("textarea",{lang:"vue"},`
  ...
  `,-1),A=m('<h3 id="排序" tabindex="-1">排序 <a class="header-anchor" href="#排序" aria-label="Permalink to &quot;排序&quot;">​</a></h3><p>对某一列数据进行排序，通过指定列的 <code>sorter</code> 函数即可启动排序按钮。当 <code>sorter</code> 为 <code>true</code> 时使用默认排序规则；当 <code>sorter</code> 为函数 <code>(rowA, rowB) =&gt; number</code> 时使用自定义排序规则。</p>',2),F=e("textarea",{lang:"vue"},`
  <script setup lang="ts">
    const columns3 = [{
      key: 'age',
      title: '年龄',
  ...
  `,-1),L=e("h3",{id:"表头分组",tabindex:"-1"},[d("表头分组 "),e("a",{class:"header-anchor",href:"#表头分组","aria-label":'Permalink to "表头分组"'},"​")],-1),O=e("p",null,"数据结构比较复杂的时候，可使用多级表头来展现数据的层次关系。",-1),M=e("p",null,[d("通过在配置表头的 "),e("code",null,"columns[n]"),d(" 内嵌 "),e("code",null,"columns"),d(" 属性，实现多级表头。")],-1),D=e("textarea",{lang:"vue"},`
  <script setup lang="ts">
    const data1 =  [
      {
        firstName: 'tanner',
  ...
  `,-1),U=e("blockquote",null,[e("p",null,[d("当前树形展开选择时存在bug: "),e("a",{href:"https://github.com/TanStack/table/issues/5620#issue-2365424488",target:"_blank",rel:"noreferrer"},"选中状态不正确")])],-1),G=e("h3",{id:"展开行",tabindex:"-1"},[d("展开行 "),e("a",{class:"header-anchor",href:"#展开行","aria-label":'Permalink to "展开行"'},"​")],-1),Q=e("p",null,[d("当表格内容较多不能一次性完全展示时。可以使用 "),e("code",null,"Table"),d(" 展开行功能。")],-1),W=e("p",null,[d("通过配置表格的 "),e("code",null,"expandable"),d(" 对象属性可以开启展开行功能。")],-1),X=e("textarea",{lang:"vue"},`
  <script setup lang="ts">
    const expandable = {
