import{A as s,_ as i,j as N}from"./chunks/theme.9mRyZSWZ.js";import{e as A,c as D,l as t,w as d,ab as _,b as e,G as a,U as g,o as B,z as u,t as I,j as n}from"./chunks/framework.MCgil6G4.js";const O=_('<h1 id="table-表格" tabindex="-1">Table 表格 <a class="header-anchor" href="#table-表格" aria-label="Permalink to &quot;Table 表格&quot;">​</a></h1><p>用于展示大量结构化数据</p><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><h3 id="基础表格" tabindex="-1">基础表格 <a class="header-anchor" href="#基础表格" aria-label="Permalink to &quot;基础表格&quot;">​</a></h3><p>通过 <code>data</code> 定义数据源, 通过 <code>columns</code> 定义列，最后一列为各种操作</p>',5),E=e("textarea",{lang:"vue"},`
  ...
  `,-1),G=e("h3",{id:"空表格",tabindex:"-1"},[a("空表格 "),e("a",{class:"header-anchor",href:"#空表格","aria-label":'Permalink to "空表格"'},"​")],-1),K=e("p",null,"数据列表没有数据时，显示空表格",-1),F=e("textarea",{lang:"vue"},`
  <template>
