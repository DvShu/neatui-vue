import{m as u}from"./chunks/theme.B1Hg1tt-.js";import{d as x,f as i,c as P,af as s,l as t,w as l,b as a,Q as o,a0 as v,o as V,u as p}from"./chunks/framework.hs56f8h4.js";const w=JSON.parse('{"title":"Input 输入框","description":"","frontmatter":{},"headers":[],"relativePath":"components/input.md","filePath":"components/input.md","lastUpdated":1729613669000}'),I={name:"components/input.md"},y=x({...I,setup(q){const m=i(""),c=i(""),h=i(""),b=i("");function g(f){let e=parseInt(f,10);return Number.isNaN(e)?e="":e=Math.abs(e),String(e)}return(f,e)=>{const n=v("CodePreview"),r=v("ClientOnly");return V(),P("div",null,[e[8]||(e[8]=s('<h1 id="input-输入框" tabindex="-1">Input 输入框 <a class="header-anchor" href="#input-输入框" aria-label="Permalink to &quot;Input 输入框&quot;">​</a></h1><p>通过鼠标或键盘输入内容，是最基础的表单域的包装。</p><h2 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to &quot;基础用法&quot;">​</a></h2><h3 id="基本使用" tabindex="-1">基本使用 <a class="header-anchor" href="#基本使用" aria-label="Permalink to &quot;基本使用&quot;">​</a></h3><p>文本输入的基础用法。</p>',5)),t(r,null,{default:l(()=>[t(n,null,{default:l(()=>e[4]||(e[4]=[a("textarea",{lang:"vue-html"},`<nt-input placeholder="请输入内容"></nt-input>
