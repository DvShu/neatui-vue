import{_ as c}from"./DocMain.vue_vue_type_style_index_0_lang-MoBQsxAA.js";import{_ as d}from"./CodeExample.vue_vue_type_style_index_0_lang-xGbo-omx.js";import{_ as p,a as _}from"./PcCodePreview.vue_vue_type_style_index_0_lang-LxYZy8Ma.js";import{_ as u}from"./Button.vue_vue_type_script_setup_true_lang-kwCzU75B.js";import{_ as b}from"./PropTable.vue_vue_type_script_setup_true_lang-9yV6FzTc.js";import{_ as f}from"./Table.vue_vue_type_script_lang-09l7sy8G.js";import{d as s,o as a,c as i,t as h,l as S,b as o,F as x,e as y,w as t,k as E,a as e}from"./index-AcABN1G1.js";import"./SourceCode.vue_vue_type_style_index_0_lang-QsnfW6Zg.js";const $={key:0},k=s({__name:"SlotTable",props:{title:{default:"Props"},data:{}},setup(m){const l=[{key:"name",title:"名称"},{key:"param",title:"参数"},{key:"description",title:"说明"}];return(n,r)=>(a(),i(x,null,[n.title!=null&&n.title!==""?(a(),i("h3",$,h(n.title),1)):S("",!0),o(f,{columns:l,data:n.data},null,8,["data"])],64))}}),v=e("h1",null,"Tooltip 文字提示",-1),g=e("p",null,"常用于展示鼠标 hover 时的提示信息。",-1),T=e("p",null," 可用来代替系统默认的 title 提示，通常用于针对一个图标按钮的鼠标悬浮显示简单说明 ",-1),w=e("p",null,"该提示使用纯 CSS 实现，所以气泡框位置通常需要手动设置",-1),B=e("p",null," 使用 title 属性来决定 hover 时的提示信息。 由 placement 属性决定展示位置: topStart、top[默认]、topEnd、bottomStart、bottom、bottomEnd ",-1),C=e("p",null," 通过使用 title 插槽来渲染自定义的提示; 如果同时传递 title 和 插槽，则 title 属性为准 ",-1),N=e("span",{style:{color:"red"}},"custome propmt text",-1),V=e("h2",null,"API",-1),D=`
<div class="demo-row">
